...
var Project = (function () {
    ...
    Project.prototype.watchProject = function () {
        var _this = this;
        if (!ts.sys.watchFile) {
            var diagnostic = TsCore_1.TsCore.createDiagnostic({ code: 5001, category: ts.DiagnosticCategory.Warning, key: "The_current_node_host_does_not_support_the_0_option_5001", message: "The current node host does not support the '{0}' option." }, "-watch");
    ...
    Project.prototype.parseProjectConfig = function () {
        ...
        try {
            ...
            var diagnostic = TsCore_1.TsCore.createDiagnostic({ code: 6064, category: ts.DiagnosticCategory.Error, key: "Cannot_read_project_path_0_6064", message: "Cannot read project path '{0}'." }, this.configFilePath);
    ...
    Project.prototype.getSettingsCompilerOptions = function (jsonSettings, configDirPath) {
        ...
        if (parsedResult.options.project) {
            var diagnostic = TsCore_1.TsCore.createDiagnostic({ code: 5099, category: ts.DiagnosticCategory.Error, key: "The_compiler_option_0_is_not_supported_in_this_context_5099", message: "The compiler option '{0}' is not supported in this context." }, "--project");
